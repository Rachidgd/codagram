...
VILLES = [
    ...
    dict(
        ...
        split_title="Vos clients sont à Villeurbanne, Bron ou Écully. Vos pages doivent y être.",
        ...
        faqs=[("Vaut-il mieux viser Lyon ou ma commune ?",
               "<p>Les deux, dans cet ordre. La commune d'abord : elle est bien plus accessible et convertit mieux. Lyon ensuite, une fois que le site a gagné en autorité. Attaquer directement la requête métropolitaine est le meilleur moyen de n'apparaître nulle part pendant un an.</p>"),
    ...
    dict(
        ...
        lead="Peu de villes françaises ont une géographie commerciale aussi fragmentée. Entre le Vieux-Port, la Joliette, les quartiers sud et l'est marseillais, votre client cherche près de chez lui. Google le suit, et vous classe secteur par secteur.",
        ...
        grid_items=[("target", "Fiche d'établissement", "Sur un marché où le bloc cartographique capte l'essentiel des clics de proximité, c'est ce qui rapporte le plus vite."),
    ...
    dict(
        ...
        cells=[("Vin", "filière et œnotourisme", "Toute une filière — négoce, tourisme, événementiel — avec un vocabulaire de recherche très spécifique."),
    ...
    dict(
        ...
        h1="Faites-vous trouver par les donneurs d'ordre toulousains.",
    ...
    dict(
        ...
        points=[("Vérifier avant de traduire", "Le volume de recherche en anglais se mesure. Il est parfois nul, parfois considérable selon le métier."),
                ("Une traduction faite par un humain", "Une traduction automatique se voit et se retourne contre vous sur une clientèle exigeante."),
    ...
    dict(
        ...
        lead="Avec l'une des plus fortes proportions d'étudiants de France et un secteur numérique installé, Rennes a un public qui compare en ligne systématiquement. Un site incomplet ou daté élimine avant même le premier contact.",
        ...
        faqs=[("La population étudiante est-elle un marché intéressant ?",
              ...
              ("Comment se différencier sur un marché où tout le monde a un bon site ?",
               "<p>Par la profondeur plutôt que par l'apparence. Quand tous les concurrents ont un site correct, la différence se fait sur le contenu. Tarifs annoncés, cas traités en détail, limites assumées. C'est plus difficile à copier qu'un design.</p>")],
    ),
    dict(
        ...
        faqs=[("Faut-il vraiment une version allemande ?",
              ...
              ("Les institutions européennes représentent-elles un marché ?",
               "<p>Indirectement, surtout. Le tissu de prestataires, de cabinets et de services qui gravite autour est bien plus accessible que les institutions, dont les achats passent par des marchés publics. C'est ce tissu périphérique que le référencement peut réellement atteindre.</p>")],
    ),
    dict(
        ...
        faqs=[("Dois-je commencer par Montpellier ou par ma commune ?",
              ...
              ("Le secteur santé impose-t-il des précautions ?",
               "<p>Oui, sur deux plans. Les moteurs appliquent une exigence de fiabilité renforcée aux contenus de santé. Et les professions réglementées ont des règles strictes sur leur communication. Nous travaillons dans ce cadre plutôt que de vous exposer.</p>")],
    ),
    dict(
        ...
        split_title="Donnez des chiffres à un prospect ingénieur, il vous consultera.",
        ...
        points=[("Des chiffres vérifiables", "Capacités, précisions, volumes traités. Ce qui permet de vous présélectionner."),
                ("Les limites annoncées", "Dire ce que vous ne faites pas installe la crédibilité sur tout le reste."),
                ("Des cas documentés", "Un problème, une contrainte, ce que vous avez fait. Le format qui circule entre professionnels.")],
        faqs=[("Mon marché est trop spécialisé pour le référencement.",
               "<p>Un marché spécialisé est le terrain le plus favorable au référencement. Peu de volume, mais une intention d'achat presque systématique et quasiment aucun concurrent sérieux en face. Dix visiteurs par mois qui cherchent exactement votre procédé valent mieux que mille visiteurs curieux.</p>"),
